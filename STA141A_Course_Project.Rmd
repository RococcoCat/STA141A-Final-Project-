...
# knn.pred <- predict(knn.model,mouse.test[,-1], type = 'prob')
# knn.predicted = as.factor((knn.pred[,2]>0.5)*1)
# 
# 
# cm.knn  = confusionMatrix(as.factor(mouse.test$feedback),as.factor((knn.pred[,2]>0.5)*1), mode = "everything")
# print(cm.knn)
...
acc[nrow(acc), ] = get_perf_metrics(mouse.test, predictions_log.bench, cm.log.bench, "Benchmark (Logistic regression)")
